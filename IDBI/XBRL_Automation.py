...
xml_dir = r"D:\Nexensus_Projects\IDBI\annual_filing_xml"      # folder containing PDFs
...
def process_xml(xml_file, selected_taxanomy):
    ...
    # for i in range(5):
        ...
        time.sleep(0.3)
        send_keys(
            r"D:\Nexensus_Projects\IDBI\annual_filing_pdfs\{}_Annual_Filing_{}.pdf".format(cin, year)
        )
        time.sleep(1)
        send_keys('{ENTER}')
...
converted_pdfs = os.listdir(r"D:\Nexensus_Projects\IDBI\annual_filing_pdfs")
excel_path = r"D:\Nexensus_Projects\IDBI\input_data\non_converted_xmls.xlsx"
