...
def startGstinScraping():
    try:
        ...
        for i in range(len(input_df)):
            print("total:", len(json.loads(input_df['GSTIN'][i])['gstinResList']))
            print(json.loads(input_df['GSTIN'][i])['gstinResList'])
            for j in json.loads(input_df['GSTIN'][i])['gstinResList']:
                if j['authStatus'].lower() == "active":
                    ...
                    try:
                        ...
                        textfile = open(r"D:\Nexensus_Projects\GST_TaxPayer\gstinError.txt", "a+")
                        ...
                        file_path = r'D:\Nexensus_Projects\GST_TaxPayer\gstinDetails_ScrapedData.csv'
                        ...
                        print("Data has been written to gstinDetails_ScrapedData.csv")
                        time.sleep(0.1)
                    break
    except Exception as e:
        print("Exception :", e)
