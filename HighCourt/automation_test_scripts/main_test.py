...
def fetch_captcha_with_retry(session, url, headers, retries=5, timeout=30):
...
# for petres_name in ["Bank"]:
#     print("current petres :", petres_name)
#     for court in courts_data:

def cases_list_collection(courts_data, rgyear, petres_name, session, headers, captcha_text):
    for court in courts_data[:]:
